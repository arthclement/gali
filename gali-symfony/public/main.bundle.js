...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getAppointments = function (id) {
        ...
        for (var _i = 0, _a = this.apiResult; _i < _a.length; _i++) {
            ...
            var appointmentsToAppend = new __WEBPACK_IMPORTED_MODULE_4__appointment__["a" /* Appointment */](appointment['id'], new Date(appointment['startdate']), {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__appointments_appointments_component__ = __webpack_require__("./src/app/appointments/appointments.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__appointments_appointments_component__["a" /* AppointmentsComponent */]
            ],
            imports: [
...
var Appointment = /** @class */ (function () {
    function Appointment(id, startDate, duration, 
        // professional: User,
        // customer: User,
        description) {
        this.id = id;
...
var AppointmentsComponent = /** @class */ (function () {
    ...
    AppointmentsComponent.prototype.getProfessionals = function () {
        var _this = this;
        this.appointmentsService.getProfessionals().subscribe(function (professionals) { return _this.professionals = professionals; });
    };
...
var AppointmentsService = /** @class */ (function () {
    function AppointmentsService(http, httpErrorHandler) {
        ...
        this.professionalsUrl = 'api/professionals';
    ...
    AppointmentsService.prototype.getProfessionals = function () {
        return this.http.get(this.professionalsUrl).pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["a" /* catchError */])(this.handleError('getProfessionals', [])));
    };
